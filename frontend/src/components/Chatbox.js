      ...
      <div className="chatbox__message">
        ...
        <div className="chatbox__message--bot">
          ...
          <div className="chatbox__message--mes">
            <p>
              Mụn đầu đen là một loại mụn phổ biến xuất hiện khi lỗ chân lông bị
              tắc nghẽn bởi dầu thừa và tế bào da chết. Dưới đây là một số cách
              cơ bản để điều trị mụn đầu đen:
            </p>
            <h3>Điều Trị Mụn Đầu Đen</h3>
            <ol>
              <li>
                <strong>Làm sạch da:</strong> Sử dụng sữa rửa mặt nhẹ nhàng,
                không chứa dầu, để loại bỏ dầu thừa và bụi bẩn. Rửa mặt hai lần
                mỗi ngày để giữ cho lỗ chân lông thông thoáng.
              </li>
              <li>
                <strong>Tẩy tế bào chết:</strong> Sử dụng sản phẩm tẩy tế bào
                chết chứa axit salicylic hoặc axit glycolic để loại bỏ tế bào da
                chết và ngăn ngừa tắc nghẽn lỗ chân lông.
              </li>
              <li>
                <strong>Sử dụng sản phẩm chứa retinoid:</strong> Retinoid giúp
                làm sạch lỗ chân lông và thúc đẩy quá trình tái tạo da, giảm mụn
                đầu đen hiệu quả.
              </li>
              <li>
                <strong>Đắp mặt nạ đất sét:</strong> Mặt nạ đất sét có khả năng
                hấp thụ dầu thừa và làm sạch sâu lỗ chân lông, giúp giảm mụn đầu
                đen.
              </li>
              <li>
                <strong>Tránh nặn mụn:</strong> Nặn mụn có thể gây viêm nhiễm và
                để lại sẹo, vì vậy tốt nhất là nên tránh.
              </li>
              <li>
                <strong>Tham khảo ý kiến chuyên gia:</strong> Nếu tình trạng mụn
                đầu đen nghiêm trọng, bạn nên gặp bác sĩ da liễu để được tư vấn
                và điều trị phù hợp.
              </li>
            </ol>
            <ul>
      ...
      <div className="chatbox__send">
        <div className="chatbox__send--input">
          <textarea
            ...
            placeholder="Ask me anything about acne..."
            name="text-input"
            id="text-input"
          ></textarea>
        </div>
